...
def _create_flirting_system_tables() -> None:
    ...
    op.create_table(
        ...
        sa.Column('user_id', sa.BigInteger(), nullable=False),
        sa.Column('group_id', sa.BigInteger(), nullable=False),
        sa.Column('relationship_level', sa.String(length=20), nullable=False, server_default='stranger'),
...
def _create_bot_friendship_tables() -> None:
    ...
    op.create_table(
        ...
        sa.Column('group_id', sa.BigInteger(), nullable=False),
        sa.Column('friendship_level', sa.String(length=20), nullable=False, server_default='acquaintance'),
    ...
    op.create_table(
        ...
        sa.Column('interaction_score', sa.Integer(), nullable=False, server_default='0'),
        sa.Column('friendship_points', sa.Integer(), nullable=False, server_default='0'),
    ...
    op.create_table(
        ...
        sa.Column('conversation_score', sa.Integer(), nullable=False, server_default='0'),
        sa.Column('is_active', sa.Boolean(), nullable=False, server_default='true'),
    ...
    op.create_table(
        ...
        sa.Column('emotion_intensity', sa.Integer(), nullable=False, server_default='0'),
...
def _create_point_system_tables() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['apploid_id'], ['apploids.apploid_id'], ondelete='CASCADE'),
        sa.ForeignKeyConstraint(['group_id'], ['groups.group_id'], ondelete='CASCADE'),
        sa.ForeignKeyConstraint(['user_id'], ['users.user_id'], ondelete='CASCADE'),
    ...
    op.create_table(
        ...
        sa.Column('current_purchases', sa.Integer(), nullable=False, server_default='0'),
        sa.Column('required_level', sa.Integer(), nullable=False, server_default='1'),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['group_id'], ['groups.group_id'], ondelete='CASCADE'),
        sa.ForeignKeyConstraint(['reward_id'], ['point_rewards.reward_id'], ondelete='CASCADE'),
        sa.ForeignKeyConstraint(['user_id'], ['users.user_id'], ondelete='CASCADE'),
...
def _create_managed_channels_table() -> None:
    ...
    op.create_table(
        ...
        sa.Column('channel_type', sa.String(length=20), nullable=False, server_default='purge'),
        sa.Column('auto_purge', sa.Boolean(), nullable=False, server_default='true'),
        sa.Column('owner_can_post', sa.Boolean(), nullable=False, server_default='true'),
...
def _create_member_profiles_table() -> None:
    ...
    op.create_table(
        ...
        sa.Column('mentions_received', sa.Integer(), nullable=False, server_default='0'),
...
def _create_indexes_and_constraints() -> None:
    ...
    op.create_index('ix_feature_toggles_feature_name', 'feature_toggles', ['feature_name'])
    ...
    op.create_index('ix_flirting_relationships_user_id', 'flirting_relationships', ['user_id'])
    ...
    op.create_index('ix_member_profiles_total_messages', 'member_profiles', ['total_messages'])
    
    # Add check constraints for data integrity
    op.create_check_constraint('ck_user_points_non_negative', 'user_points', sa.text('current_points >= 0 AND total_earned >= 0 AND total_spent >= 0'))
    op.create_check_constraint('ck_user_points_level_positive', 'user_points', sa.text('level > 0'))
    op.create_check_constraint('ck_flirting_attempts_points_non_negative', 'flirting_attempts', sa.text('points_earned >= 0'))
    op.create_check_constraint('ck_bot_friendships_score_valid', 'bot_friendships', sa.text('friendship_score >= 0 AND friendship_score <= 100'))
    op.create_check_constraint('ck_point_transactions_amount_valid', 'point_transactions', sa.text('amount != 0'))
