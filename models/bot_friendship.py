...
class BotFriendship(Base, TimestampMixin):
    ...
    companion_bot_id: Mapped[int] = mapped_column(BigInteger, nullable=False, index=True)
    ...
    friendship_level: Mapped[str] = mapped_column(String(20), default="acquaintance", nullable=False)  # acquaintance, friend, close_friend, best_friend
    friendship_score: Mapped[int] = mapped_column(Integer, default=0, nullable=False)  # 0-100
    is_active: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)
    bonded_at: Mapped[int] = mapped_column(BigInteger, nullable=False)  # Unix timestamp
    last_interaction: Mapped[int] = mapped_column(BigInteger, nullable=False)  # Unix timestamp
...
class BotInteraction(Base, TimestampMixin):
    ...
    interaction_score: Mapped[int] = mapped_column(Integer, default=0, nullable=False)  # -10 to +10
    friendship_points: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
    interaction_time: Mapped[int] = mapped_column(BigInteger, nullable=False)  # Unix timestamp
...
class BotMemory(Base, TimestampMixin):
    ...
    memory_type: Mapped[str] = mapped_column(String(30), nullable=False, index=True)  # shared_experience, inside_joke, milestone, adventure
    ...
    participants: Mapped[str] = mapped_column(Text, nullable=True)  # JSON string of user IDs
    ...
    memory_time: Mapped[int] = mapped_column(BigInteger, nullable=False)  # Unix timestamp
...
class BotConversation(Base, TimestampMixin):
    ...
    conversation_type: Mapped[str] = mapped_column(String(30), nullable=False, index=True)  # casual, deep, playful, romantic, strategic
    message_count: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
    conversation_score: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
    is_active: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)
    started_at: Mapped[int] = mapped_column(BigInteger, nullable=False)  # Unix timestamp
    last_message_at: Mapped[int] = mapped_column(BigInteger, nullable=False)  # Unix timestamp
...
class BotEmotion(Base, TimestampMixin):
    ...
    emotion_type: Mapped[str] = mapped_column(String(30), nullable=False, index=True)  # happiness, excitement, affection, concern, pride, jealousy
    emotion_intensity: Mapped[int] = mapped_column(Integer, default=0, nullable=False)  # 0-10
    ...
    emotion_time: Mapped[int] = mapped_column(BigInteger, nullable=False)  # Unix timestamp
