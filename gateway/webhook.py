...
UPDATE_COUNTER = Counter("nico_robin_telegram_updates_total", "Total Telegram updates received.")
UPDATE_LATENCY = Histogram("nico_robin_update_processing_seconds", "Time processing updates.")
...
def create_app(ptb_app: Application) -> FastAPI:
    app = FastAPI(title="Nico Robin Bot", version="2.0.0", docs_url=None, redoc_url=None)
