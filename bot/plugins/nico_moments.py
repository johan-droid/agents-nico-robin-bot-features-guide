...
async def pat(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    try:
        ...
        await msg.reply_text(f"🌸 Nico Robin gently pats {user_mention}\n\n{moment['description']}")
...
async def slap(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    try:
        ...
        # Fallback to text if GIF fails
        await msg.reply_text(f"🌸 Nico Robin slaps some sense into {user_mention}!\n\n{moment['description']}")
...
async def hug(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    try:
        ...
        # Fallback to text if GIF fails
        await msg.reply_text(f"🌸 Nico Robin gives {user_mention} a warm hug\n\n{moment['description']}")
...
async def robin_blush(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    try:
        ...
        # Fallback to text if GIF fails
        await msg.reply_text(f"🌸 Nico Robin blushes at {user_mention}\n\n{moment['description']}")
...
async def robin_angry(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    try:
        ...
        # Fallback to text if GIF fails
        await msg.reply_text(f"🌸 Nico Robin gives her dangerous glare\n\n{moment['description']}")
...
async def robin_dance(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    try:
        ...
        # Fallback to text if GIF fails
        await msg.reply_text(f"🌸 Nico Robin shows her dance moves\n\n{moment['description']}")
...
async def robin_sleep(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    try:
        ...
        # Fallback to text if GIF fails
        await msg.reply_text(f"🌸 Nico Robin is sleeping peacefully\n\n{moment['description']}")
