...
from bot.middleware.group_guard import group_guard, group_guard_error_handler, _StopProcessing
...
def create_application(app_settings: Settings = settings) -> Application:
    ...
    application.add_handler(TypeHandler(type=object, callback=_rate_limit_gate), group=-1)
